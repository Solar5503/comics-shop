...
const ComicCard = ({ comic }: ComicCardProps) => {
  ...
  const formatColorStyle: Record<string, string> = {
    Comic: styles['comic-card__header--comic'],
    DigitalVerticalComic: styles['comic-card__header--digital-vertical-comic'],
    TradePaperback: styles['comic-card__header--trade-paperback'],
    Hardcover: styles['comic-card__header--hardcover'],
    DigitalComic: styles['comic-card__header--digital-comic'],
    Digest: styles['comic-card__header--digest'],
  }
        ...
        >
          ...
          >
            ...
            <path
              ...
              stroke="#fff"
              strokeLinecap="round"
              fill={isComicAddingToCart ? '#fff' : 'none'}
            />
